...
class View2(tk.Frame):
    ...
    def generate_random_data(self):
        self.first_name.set(self.generate_random_name())
        self.last_name.set(self.generate_random_last_name())
        self.age.set(self.generate_random_age())
        self.gender.set(self.generate_random_gender())
        self.relationship_preference.set(self.generate_random_relationship_preference())
        
    def generate_random_name(self):
        names = ["Alice", "Bob", "Charlie", "Daisy", "Ethan", "Fiona"]
